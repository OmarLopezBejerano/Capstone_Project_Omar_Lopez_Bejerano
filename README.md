...
## Deep Learning BP Prediction Model
...
```
Conv1D(3×3) -> BatchNorm -> ReLU -> Dropout(0.2) -> Conv1D(3×3) -> BatchNorm -> Add(skip connection) -> ReLU
```
...
### Test Set Results Visualizations

**Error Distribution Analysis:**

![Error Analysis](model/test/error_analysis.png)
*Error distribution plots showing prediction errors for SBP and DBP on test set. Includes histograms, scatter plots of predicted vs. actual values, and residual plots.*

**Bland-Altman Agreement Analysis:**

![Bland-Altman Plots](model/test/bland_altman_plots.png)
*Bland-Altman plots for SBP and DBP showing agreement between predicted and reference values. Dashed lines indicate mean bias and 95% limits of agreement (±1.96 SD).*

### Adaptation to Garmin Wearables
...
![Garmin HRM Processing Pipeline](garmin/figures/garmin_hrm_processing_pipeline.png)
*Example of Garmin signal processing pipeline. Device heart rate variability data processed into 10-second windows for deep learning input.*
